...
![](/blogs/使用Profiler调试React应用/react-profiler-001.jpg)
...
![渲染结果](/blogs/使用Profiler调试React应用/react-profiler-002.jpg)
...
![渲染结果](/blogs/使用Profiler调试React应用/react-profiler-003.jpg)
...
![渲染结果](/blogs/使用Profiler调试React应用/react-profiler-004.jpg)
...
![渲染结果](/blogs/使用Profiler调试React应用/react-profiler-005.jpg)
...
![渲染结果](/blogs/使用Profiler调试React应用/react-profiler-006.jpg)
